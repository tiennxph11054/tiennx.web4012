...
<div class="row">
    <form action="" method="get">
        <div class="row">
            <div class="col-md-3">
                <input class="form-control" type="text" name="keyword" placeholder="Từ khóa sản phẩm...">
            </div>
            <div class="col-md-3">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                if ($item->status == 1) {
                ?>
                    <a href="{{route('admin.products.activePro' , $item->id)}}" class="btn btn-primary">
                ...
                ?>
                    <a href="{{route('admin.products.unactivePro' , $item->id)}}" class="btn btn-warning">
