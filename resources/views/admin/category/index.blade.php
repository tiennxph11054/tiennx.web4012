...
<div class="row">
    ...
    <div class="col-md-6">
        <a href="{{route('admin.categories.create')}}" class="btn btn-success float-right m-2">
            Thêm mới
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p style="color: red;">{{$cate_child->name}}</p>
                @endif
                @endforeach
                @endif
            </td>
            <td>
                <a href="{{route('admin.categories.edit',['id'=>$item->id])}}" class="btn btn-primary">
